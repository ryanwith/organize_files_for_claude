...
# CONFIGURATION
GITIGNORE_FILE = Path('/Users/ryanwith/dev/melchi_data/.gitignore') # optional, set to None if not needed
SOURCE_DIRECTORY = Path('/Users/ryanwith/dev/melchi_data')  # Set your source directory
TARGET_DIRECTORY = Path('/Users/ryanwith/dev/melchi_files_for_claude')  # Set your target directory
